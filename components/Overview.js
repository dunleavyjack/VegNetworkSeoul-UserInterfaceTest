      ...
      <div className="container mt-5">
        <div className="row">
          <div className="col-sm">
            ...
            <p className="mt-3">
              Find all the best vegan and vegtarian finds in the city, all added
              by people living there. Discover all the best and latest snacks,
              drinks, meals, and grocery supplies.
            </p>
          </div>
          <div className="col-sm">
